...
class TodayWeatherFragment : Fragment(), TodayWeatherView {
    ...
    override fun onCreateView(
        ...
        temperatureAndWeatherTextView = root.findViewById<TextView>(R.id.temperature_tv)
        pressureTextView = root.findViewById<TextView>(R.id.pressure_tv)
        humidityTextView = root.findViewById<TextView>(R.id.humidity_tv)
        windSpeedTextView = root.findViewById<TextView>(R.id.wind_speed_tv)
        windDirectionTextView = root.findViewById<TextView>(R.id.wind_direction_tv)
        locationTextView = root.findViewById<TextView>(R.id.location_tv)
        precipitationTextView = root.findViewById<TextView>(R.id.rainfall_level_tv)
